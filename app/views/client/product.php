...
<body>
    ...
    <section class="relative mx-auto">
            ...
            <div class="px-5 xl:px-12 py-6 flex w-full items-center ">
                ...
                <div class="hidden xl:flex items-center space-x-5 items-center">
                    <div class="relative hidden md:block">
                        ...
                        <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." oninput="searchProducts()">
                    </div>
        ...
        <div class="w-[92%] m-auto  overflow-y-auto flex justify-center flex-wrap scroll-hidden mt-2">
            ...
            ?>
                <button class="text-sm text-gray-700 leading-5 hover:text-white hover:bg-gray-800 mx-1 md:my-0 border border-black border-solid rounded-full py-[3px] px-[25px]" href="#"><?= $CatProd->Name_cate ?></button>
