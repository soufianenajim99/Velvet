...
<body class="bg-gray-100">
    <div class="flex flex-col h-screen bg-gray-100">
        ...
        <div class="bg-white text-white shadow w-full p-2 flex items-center justify-between">
            ...
            <div class="space-x-5">
                <button>
                    <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 21">
                ...
                <button>
                    <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex-1 flex flex-wrap">
            <div class="p-2 bg-white w-full md:w-60 flex flex-col md:flex hidden" id="sideNav">
                <nav><a class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white" href="index">
                        <i class="fas fa-home mr-2"></i>dashboard
                    </a>
                    <a class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white" href="users">
                        <i class="fas fa-users mr-2"></i>Users
                    </a>

                    <a class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white" href="categories">
                        <i class="fas fa-file-alt mr-2"></i>Categories
                    </a>

                    <a class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white" href="products">
                                    ...
                                    <td class="flex justify-center">
                                        ...
                                        <button type="button" data-modal-toggle="delete-product-modal">
                                            <a href="<?= URLROOT ?>product/deleteproduct/<?= $product->Id_product ?>">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
