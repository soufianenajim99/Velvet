    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="categoryName" name="fullname" placeholder="Enter category name"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="categoryDescription" name="username" placeholder="Enter category description"
            ...
            <div class="mb-4">
                ...
                <input type="password" id="categoryDescription" name="password" placeholder="Enter category description"
                    class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></input>
            </div>

            <div class="mb-4">
                <label for="categoryDescription" class="block text-gray-700 text-sm font-bold mb-2">Adresse</label>
                <input type="text" id="categoryDescription" name="Adresse" placeholder="Enter category description"
                    class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></input>
            </div>

            <div class="mb-4">
                <label for="categoryDescription" class="block text-gray-700 text-sm font-bold mb-2">Email</label>
                <input type="email" id="categoryDescription" name="Email" placeholder="Enter category description"
                    class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></input>
            </div>
