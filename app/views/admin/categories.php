                        ...
                        <table id="dataTable" class="w-full table-auto text-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-grey-lighter">
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $cat->Id_category ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $cat->Name_cate ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light "><?= $cat->Desc_cate ?></td>
                                    <td class="flex justify-center"><button type="button"
                                            data-modal-toggle="product-modal">
                                            <a href="<?= URLROOT ?>category/updateCategory/<?= $cat->Id_category ?>">
                                        ...
                                        <button type="button" data-modal-toggle="delete-product-modal">
                                            <a href="<?= URLROOT ?>category/deleteCategory/<?= $cat->Id_category ?>">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    viewBox="0 0 18 20">
                                                    <path
