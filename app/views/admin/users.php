            ...
            <div class="flex-1 p-4 w-full md:w-1/2">
                ...
                <div class="mt-8 bg-white p-4 shadow rounded-lg">
                    <div class="bg-white p-4 rounded-md mt-4">
                        <h2 class="text-gray-500 text-lg font-semibold pb-4">Admins</h2>
                        <div class="my-1"></div>
                        ...
                        <table class="w-full table-auto text-sm">
                            ...
                            <tbody>
                                <?php
                                 foreach ($data["ads"] as $adm) {
                                 
                                ?>
                                <tr class="hover:bg-grey-lighter">
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $adm->id ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $adm->FullName ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <?= $adm->username ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <?= $adm->password ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                    ...
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <button type="button" data-modal-toggle="product-modal">
                                            <a href="<?= URLROOT ?>adminn/updateAdmin/<?= $adm->id ?>">
                                        ...
                                        <button type="button" data-modal-toggle="delete-product-modal">
                                            <a href="<?= URLROOT ?>adminn/deleteAdmin/<?= $adm->id ?>">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    viewBox="0 0 18 20">
                                                    <path
                        ...
                        <div class="text-right mt-4">
                            <button class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded">
                                <a href="<?=URLROOT?>adminn/addAdmin">
                                    add Admin
                                </a>
                            </button>
                        </div>
                ...
                <div class="mt-8 bg-white p-4 shadow rounded-lg">
                    <div class="bg-white p-4 rounded-md mt-4">
                        ...
                        <table class="w-full table-auto text-sm">
                            ...
                            <tbody>
                                <?php
                                 foreach ($data["clis"] as $cat) {
                                 
                                ?>
                                <tr class="hover:bg-grey-lighter">
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $cat->id ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light"><?= $cat->FullName ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <?= $cat->username ?></td>
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <?= $cat->password ?></td>
                                    ...
                                    <td class="py-2 px-16 border-b border-grey-light text-right">
                                        <button type="button" data-modal-toggle="product-modal">
                                            <a href="<?= URLROOT ?>clientt/updateClient/<?= $cat->id ?>">
                                        ...
                                        <button type="button" data-modal-toggle="delete-product-modal">
                                            <a href="<?= URLROOT ?>clientt/deleteClient/<?= $cat->id ?>">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-gray-500" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    viewBox="0 0 18 20">
                                                    <path
                        ...
                        <div class="text-right mt-4">
                            <button class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded">
                                <a href="<?=URLROOT?>clientt/addClient">
                                    add Client
                                </a>
                            </button>
                        </div>
