...
<body>
    <div class="h-screen md:flex">
        <div
            class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-orange-400 to-orange-700 i justify-around items-center hidden">
            <div>
                <h1 class="text-white font-bold text-4xl font-sans">Velvet</h1>
                <p class="text-white mt-1">The most popular peer to peer lending at SEA</p>
                <a href="./login.php"
                    class="text-center block w-28 bg-white text-orange-800 mt-4 py-2 rounded-2xl font-bold mb-2">
                    Login
                </a>
            </div>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form action="../../app/controllers/mainController.php" method="post" class="bg-white">
                <h1 class="text-orange-800 font-bold text-2xl mb-1">Hello Again!</h1>
                <p class="text-sm font-normal text-orange-600 mb-7">Welcome Back</p>
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-400" viewBox="0 0 20 20"
                        fill="currentColor">
                ...
                <div class="flex justify-center gap-8">
                    <div class="roleType">
                        ...
                        <label for="client">Valid</label>
                    </div>
                </div>
                <button type="submit" name="signup"
                    class="block w-full bg-orange-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Sign Up
                </button>
