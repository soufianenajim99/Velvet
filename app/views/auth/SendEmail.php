...
<body>
    <div
        class="min-h-screen bg-[url('<?= Config::get('app.url') ?>public/images/LOgiiin.jpg')] bg-cover bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                ...
                <div
                    ...
                    <div class="w-full">
                        <div class="text-center">
                            <h1 class="text-3xl font-semibold text-gray-900">Send Message Email</h1>
                        </div>
                        <div class="mt-5">
                            <form action="path/to/your/resetPasswordController" method="post">
                                ...
                                <div class="my-6">
                                    <button type="submit"
                                        class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Envoie</button>
                                </div>
